...
The page has also read itself. The screen share was pointed at this page while
the set ran on it, so each frame folds the code, the text and the picture of
the frame before it back through the chain.
