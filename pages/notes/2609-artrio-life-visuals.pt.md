...
A página também se leu. O compartilhamento de tela apontava para esta página
enquanto o set rodava nela, então cada quadro dobra o código, o texto e a
imagem do quadro anterior de volta pela cadeia.

![A página dobrada através do set, com o código ainda legível sob um banho vermelho](../../src/assets/images/notes/2609-artrio-life-visuals/page-through-itself-red.png)

![A mesma imagem um instante depois, quebrada em blocos pixelizados](../../src/assets/images/notes/2609-artrio-life-visuals/page-through-itself-blocks.png)

![A realimentação em azul, com as colunas dos quadros anteriores ainda de pé](../../src/assets/images/notes/2609-artrio-life-visuals/page-through-itself-blue.png)

![Um quadro carmesim com uma coluna clara no centro](../../src/assets/images/notes/2609-artrio-life-visuals/page-through-itself-crimson.png)
